...
button{margin-top:20px;padding:15px;width:100%;background:#10b981;color:#fff;border:none;border-radius:10px;font-weight:600;cursor:pointer}
...
<div class="container">
    <h2>🔌 Diagnosa Laptop</h2>
    <p>Masukkan gejala yang terjadi pada Laptop Anda</p>

    <form method="POST" action="/proses">
        @csrf
        <input type="text" name="gejala[]" placeholder="Contoh: Layar blank / cepat panas">
