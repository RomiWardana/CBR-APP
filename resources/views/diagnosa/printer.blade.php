...
button{margin-top:20px;padding:15px;width:100%;background:#f59e0b;color:#fff;border:none;border-radius:10px;font-weight:600;cursor:pointer}
...
<div class="container">
    <h2>🖨️ Diagnosa Printer</h2>
    <p>Masukkan gejala yang terjadi pada Printer Anda</p>

    <form method="POST" action="/proses">
        @csrf
        <input type="text" name="gejala[]" placeholder="Contoh: Hasil cetak bergaris / tidak keluar tinta">
